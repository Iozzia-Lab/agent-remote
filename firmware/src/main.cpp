...
String portalHtml() {
  ...
  String h =
    ...
    "<style>body{font-family:-apple-system,sans-serif;max-width:440px;margin:0 auto;"
    "padding:24px 16px;background:#111;color:#eee}h2{text-align:center;color:#0cf}"
    ...
    "button{background:#0a7;color:#fff;border:0;margin-top:18px;font-weight:600}"
